...
let
  ...
  bg = colors.dracula.primary.background;
  fg = colors.dracula.primary.foreground;

  # Colored
  primary = colors.dracula.primary.bright_foreground;

  # Dark
  secondary = "#141228";

  # Colored (light)
  tertiary = colors.dracula.primary.purple;
  ...
  services.polybar = {
    ...
    config = {
      ...
      "module/i3" = {
        ...
        # Could use icons in the future; leaving here as examples
        # See below for their use
        ws-icon-0 = "1;";
        ws-icon-1 = "2;";
        ws-icon-2 = "3;﬏";
        ws-icon-3 = "4;";
        ...
        # This would have to  be %icon% to use the icons when unfocused
        label-unfocused = "%index%";
        label-unfocused-foreground = quinternary;
        label-unfocused-padding = 1;

        # This would need to be %index% %icon% for icons when focused
        label-focused = "%index%";

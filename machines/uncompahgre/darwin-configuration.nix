...
in
{
  ...
  home-manager.users.aaronarinder = {
    home.packages = with pkgs; [
      ...
      # nvim-treesitter's main branch builds parsers with the tree-sitter
      # CLI instead of shipping them, so it has to be on $PATH. Needs
      # >= 0.26.1, and specifically not the npm build.
      tree-sitter
